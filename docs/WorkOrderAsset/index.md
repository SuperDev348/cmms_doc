...
# Create WorkOrderAsset 

This object is used for linking a work order to an asset.

Create an WorkOrderAsset if  WorkOrderAsset does not already exist.


**URL** : `/api/workorderasset`
...
| :------------- |  :----------- |----------- |
|  intWorkOrderID |  Integer    | The ID of the work order. For possible values, please refer to the WorkOrder section.|
|  intAssetID |  Integer    | The ID of the asset. For possible values, please refer to the Asset section.|
...
**URL** : `/api/workorderasset/:workorderassetid`
